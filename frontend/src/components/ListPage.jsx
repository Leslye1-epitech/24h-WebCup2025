...
// Importez themes de CreatePage ou créez-le ici si vous préférez 
// l'avoir indépendant
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {examplePages.map(page => (
            <div key={page.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className={`p-1 ${themes[page.theme].bg}`}></div>
              <div className="p-6">
                ...
                <div className="flex items-center gap-1 mb-4">
                  <span className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs ${themes[page.theme].bg} ${themes[page.theme].text}`}>
